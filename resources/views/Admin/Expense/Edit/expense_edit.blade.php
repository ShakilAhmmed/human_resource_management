...
@endif -->
     ...
     <div class="col-lg-12">
                                ...
                                <div class="card-body">
                                     <!-- tab -->
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Expense Edit</a>
                                            </li>
                                        </ul>
                                    <!-- tab end -->
                      ...
                      {{Form::open(['url'=>"/expense/$edit_data->id" ,'method'=>'put'])}}

                            <div class="card-body card-block">
                             <div class="form-group">                                    
                                {{Form::label('Expense Titles','',['class'=>'control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                                       {{Form::text('expense_title',$edit_data->expense_title,['title'=>'expense_title'])}}
                                    </div>
                                </div>
                                ...
                                {{Form::label('Amount','',['class'=>'control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                                       {{Form::number('amount',$edit_data->amount,['class'=>'form-control','title'=>'amount','required'=>'required'])}}
                                    </div>
                                </div>
                                ...
                                {{Form::label('Date','',['class'=>'control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                                       {{Form::date('date',$edit_data->date,['class'=>'form-control','title'=>'date','required'=>'required'])}}
                                    </div>
                                </div>
