                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            &nbsp;
                                             ...
                                             <li class="nav-item">
                                              ...
                                              <li class="nav-item">
                                                <a style="background: #2ecc71;color: white;" class="nav-link" id="save-tab" data-toggle="tab" href="#save" role="tab" aria-controls="documents" aria-selected="false">UPDATE</a>
                                            </li>
                                        </ul>
          {{Form::open(['url'=>"/employee/$employee_data->employee_personal_details_id",'files'=>true,'method'=>'put'])}}
                                    <!-- tab end -->
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="card-body card-block">
                                ...
                                {{Form::label('name','Name',['class'=>'form-control-label'])}}
                                   ...
                                   {{Form::text('name',$employee_data->name,['class'=>'form-control','title'=>'name'])}}
                                    </div>
                         ...
                         {{Form::label('father_name','Father Name',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('father_name',$employee_data->father_name,['class'=>'form-control','title'=>'father_name'])}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                     {{Form::date('date_of_bith',$employee_data->date_of_bith,['class'=>'form-control','title'=>'date_of_bith'])}}
                                    </div>
                                ...
                                {{Form::label('gender','Gender',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                       {{Form::select('gender',[$employee_data->gender=>$employee_data->gender,'Male'=>'Male','Female'=>'Female'],null,['class'=>'form-control','title'=>'gender'])}}
                                    </div>
                                ...
                                {{Form::label('phone','Phone',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                       {{Form::text('phone',$employee_data->phone,['class'=>'form-control','title'=>'phone'])}}
                                    </div>
                                ...
                                {{Form::label('present_address','Present Address',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                           {{Form::textarea('present_address',$employee_data->present_address,['class'=>'form-control','title'=>'present_address','rows'=>'4','cols'=>'4'])}}
                                    </div>
                                ...
                                {{Form::label('permanent_address','Permanent Address',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                           {{Form::textarea('permanent_address',$employee_data->permanent_address,['class'=>'form-control','title'=>'permanent_address','rows'=>'4','cols'=>'4'])}}
                                    </div>
                              ...
                              <div class="form-group">
                                {{Form::label('nationality','Nationality',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                       {{Form::text('nationality',$employee_data->nationality,['class'=>'form-control','title'=>'nationality'])}}
                                    </div>
                                ...
                                {{Form::label('marital_status','Marital Status',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                       {{Form::select('marital_status',[$employee_data->marital_status=>$employee_data->marital_status,'Married'=>'Married','Single'=>'Single'],null,['class'=>'form-control','title'=>'marital_status'])}}
                                    </div>
                ...
                {{Form::label('','',['class'=>'control-label','title'=>''])}}
                  <div class="input-group">
                   {{Form::image($employee_data->profile_image,'Profile_image',['alt'=>'Your Image','class'=>'img-responsive img-circle','id'=>'blah','style'=>'width:19%;height:19%;'])}}
                  </div>
                </div>
                <div class="form-group">
                          ...
                          <div class="col-xs-12 col-sm-12">
                            <div class="card-body card-block">
                                ...
                                {{Form::label('employee_code','Employee Code',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                         {{Form::text('employee_code',$employee_data->employee_code,['class'=>'form-control','title'=>'employee_code','readonly'=>'readonly'])}}
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('department',$employee_data->department,['class'=>'form-control','title'=>'department'])}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('designation_name',$employee_data->designation_name,['class'=>'form-control','title'=>'designation_name'])}}
                                    </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::date('date_of_joining',$employee_data->date_of_joining,['class'=>'form-control','title'=>'date_of_joining'])}}
                                    </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('joining_sallary',$employee_data->joining_sallary,['class'=>'form-control','title'=>'joining_sallary'])}}
                                    </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('shift',$employee_data->shift,['class'=>'form-control','title'=>'shift'])}}
                                    </div>
                                ...
                                {{Form::label('status','Status',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                       {{Form::select('status',[$employee_data->status=>$employee_data->status,'Active'=>'Active','Inactive'=>'Inactive'],null,['class'=>'form-control','title'=>'status'])}}
                                    </div>
                          ...
                          <div class="col-xs-12 col-sm-12">
                            <div class="card-body card-block">
                                ...
                                {{Form::label('account_holder_name','Account Holder Name',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                         {{Form::text('account_holder_name',$employee_data->account_holder_name,['class'=>'form-control','title'=>'account_holder_name'])}}
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('account_number',$employee_data->account_number,['class'=>'form-control','title'=>'account_number','readonly'=>'readonly'])}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('bank_name',$employee_data->bank_name,['class'=>'form-control','title'=>'bank_name'])}}
                                    </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('branch_name',$employee_data->branch_name,['class'=>'form-control','title'=>'branch_name'])}}
                                    </div>
                          ...
                          <div class="col-xs-12 col-sm-12">
                            <div class="card-body card-block">
                                ...
                                {{Form::label('email','Email',['class'=>'form-control-label'])}}
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                         {{Form::email('email',$employee_data->email,['class'=>'form-control','title'=>'email'])}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('confirm_password','',['class'=>'form-control','title'=>'confirm_password'])}}
                                    </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                        {{Form::text('role',$employee_data->role,['class'=>'form-control','title'=>'role'])}}
                                    </div>
      ...
      <div style="margin-top: 30px;">
              <div>
               <div style="display: inline-flex;">
                ...
                <table>
                  <tr>
                  @foreach($employee_data->job as $job_details)
                   <td>
                   <input type='text' class='form-control' name='company_name[]' style='margin-left: 21px;width: 194px;' value="{{$job_details->company_name}}" />
                  </td>
                  <td>
                 <input type='text' class='form-control' name='job_department[]' style='margin-left: 21px;width: 194px;' value="{{$job_details->job_department}}"/>
                  </td>
                  <td>
                   <input type='text' class='form-control' name='designation[]'  style='margin-left: 21px;width: 194px;' value="{{$job_details->designation}}"/>
                  </td>
                  <td>
                    <input type='date' class='form-control' name='start_date[]'  style='margin-left: 21px;width: 194px;' value="{{$job_details->start_date}}"/>
                  </td>
                  <td>
                   <input type='date' class='form-control' name='end_date[]' style='margin-left: 21px;width: 194px;' value="{{$job_details->end_date}}"/>
                  </td>
                  <td>
              ...
              <div>
               <div style="display: inline-flex;">
                ...
                <table>
                  <tr>
                  @foreach($employee_data->file as $file)
                  <td>

                  {{Form::text('document_file_name[]',$file->document_file_name,['class'=>'form-control','style'=>'margin-left:21px;width:194px;','readonly'=>'readonly'])}}
                  </td>
                 <td>
                  {{Form::image($file->document,'',['alt'=>'Your Image','class'=>'img-responsive img-circle','style'=>'width:20.5%;height:19%;margin-left:2%;'])}}
                  </td>
                 </tr>
                 @endforeach
                </table>
